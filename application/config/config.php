...
|
*/
$config['base_url'] = 'http://luchi.lcl/'; // ON DEV
//$config['base_url'] = 'http://localhost/site_app_template'; // ON LOCAL
...
|
*/
$config['encryption_key'] = 'altsairBnB';
