...
for (var i = 0; i < oScripts.length; i++) {
    ...
    if (sSrc.indexOf("file_beautify.js") != -1) sScriptPath = oScripts[i].src.replace(/file_beautify.js/, "");
...
if ((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i))) {
    ...
    jQuery.contentbuilder = function(element, options) {
        ...
        this.init = function() {
            ...
            if (jQuery('#divCb')
                .length == 0) {
                jQuery('body')
                    .append('<div id="divCb"></div>')
            }
            if (jQuery('#divSnippets')
                .length == 0) {
                jQuery('#divCb')
                    .append('<div id="divSnippets" style="display:none"></div>');
                var html_catselect = '';
                ...
                jQuery('#divCb')
                    .append(s);
                jQuery('#inpZoom')
                    .val(this.settings.zoom * 100);
                jQuery('#divCb input[type="range"]')
                    .rangeslider({
                        onSlide: function(position, value) {},
                        polyfill: false
                    });
                var val = jQuery('#inpZoom')
                    .val() / 100;
                this.zoom(val);
                jQuery('#inpZoom')
                    .on('change', function() {
                ...
                jQuery.get(this.settings.snippetFile, function(data) {
                    ...
                    jQuery('<div/>')
                        ...
                        .each(function() {
                            var block = jQuery(this)
                                .html();
                            var blockEncoded = jQuery('<div/>')
                                .text(block)
                                .html();
                            htmlData += '<div id="snip' + i + '">' + blockEncoded + '</div>';
                            if (jQuery(this)
                                .data("cat") != null) bUseSnippetsFilter = true;
                            if (bUseSnippetsFilter) {
                                htmlThumbs += '<div style="display:none" title="Snippet ' + i + '" data-snip="' + i + '" data-cat="' + jQuery(this)
                                    .data("cat") + '"><img src="' + jQuery(this)
                                    .data("thumb") + '" /></div>'
                            } else {
                                htmlThumbs += '<div title="Snippet ' + i + '" data-snip="' + i + '" data-cat="' + jQuery(this)
                                    .data("cat") + '"><img src="' + jQuery(this)
                                    .data("thumb") + '" /></div>'
                            }
                            i++
                    ...
                    jQuery('#divSnippets')
                        .html(htmlData);
                    jQuery($element.data('contentbuilder')
                    ...
                    if (bUseSnippetsFilter) {
                        ...
                        jQuery($element.data('contentbuilder')
                                .settings.snippetList + ' > div')
                            .each(function() {
                                for (var j = 0; j < jQuery(this)
                                    .attr('data-cat')
                                    .split(',')
                                    .length; j++) {
                                    var catid = jQuery(this)
                                        .attr('data-cat')
                                        .split(',')[j];
                                    if (catid == 0) {
                                        jQuery(this)
                        ...
                        jQuery('#selSnips option')
                            .each(function() {
                                var catid = jQuery(this)
                                    .attr('value');
                                if (jQuery.inArray(catid, cats) == -1) {
                                    if (catid != 0 && catid != -1) {
                                        jQuery("#selSnips option[value='" + catid + "']")
                                            .remove()
                                    }
                                }
                            });
                        if (!defaultExists) {
                            jQuery($element.data('contentbuilder')
                                    .settings.snippetList + ' > div')
                                .css('display', 'block');
                            jQuery("#selSnips option[value='0']")
                                .remove()
                        }
                        jQuery('#selSnips')
                            .css('display', 'block');
                            ...
                            .draggable({
                                ...
                                drag: function(event, ui) {
                                    ...
                                    jQuery(ui.helper)
                                        .css("height", "60px");
                                    jQuery(ui.helper)
                                        .css("border", "rgba(225,225,225,0.9) 5px solid");
                                    ...
                                    zoom = zoom * 1;
                                    var scrolltop = jQuery(window)
                                        .scrollTop();
                                    var offsettop = jQuery(event.target)
                                        .offset()
                                        .top;
                                    var offsetleft = jQuery(event.target)
                                        .offset()
                                        .left;
                                    ...
                                    if (browserok) {
                                        ...
                                        jQuery(ui.helper)
                                            .css("margin-top", (event.clientY + adjy - ((event.clientY + adjy) * newzoom)) + (scrolltop + 0 - ((scrolltop + 0) * newzoom)));
                                        jQuery(ui.helper)
                                            .css("margin-left", event.clientX + adjx - ((event.clientX + adjx) * zoom))
                                    } else {
                                        if (is_ie) {}
                                        if (is_firefox) {}
                                    }
            ...
            $element.children("*")
                .wrap("<div class='ui-draggable'></div>");
            $element.children("*")
                .append('<div class="row-tool">' + '<div class="row-handle"><i class="cb-icon-move"></i></div>' + '<div class="row-html"><i class="cb-icon-code"></i></div>' + '<div class="row-copy"><i class="cb-icon-plus"></i></div>' + '<div class="row-remove"><i class="cb-icon-cancel"></i></div>' + '</div>');
            if (jQuery('#temp-contentbuilder')
                .length == 0) {
                jQuery('#divCb')
                    .append('<div id="temp-contentbuilder" style="display: none"></div>')
            }
            ...
            if (this.settings.snippetTool == 'right') {
                jQuery('#divTool')
                    .css('width', toolwidth + 'px');
                jQuery('#divTool')
                    .css('right', '-' + toolwidth + 'px');
                jQuery("#lnkToolOpen")
                    .unbind('click');
                jQuery("#lnkToolOpen")
                    .click(function(e) {
                        $element.data('contentbuilder')
                            .clearControls();
                        if (parseInt(jQuery('#divTool')
                                .css('right')) == 0) {
                            jQuery('#divTool')
                                .animate({
                                    right: '-=' + toolwidth + 'px'
                                }, 200);
                            jQuery("#lnkToolOpen i")
                                .attr('class', 'cb-icon-left-open-big')
                        } else {
                            jQuery('#divTool')
                                .animate({
                                    right: '+=' + toolwidth + 'px'
                            ...
                            jQuery("#lnkToolOpen i")
                                .attr('class', 'cb-icon-right-open-big')
                        }
                        e.preventDefault()
                    });
                jQuery('.row-tool')
            ...
            $element.sortable({
                ...
                deactivate: function(event, ui) {
                            ...
                            .each(function() {
                                ...
                                if (jQuery(this)
                                    ...
                                    if (jQuery(this)
                                        .children(0)
                                        .prop("tagName")
                                        .toLowerCase() == 'img' && jQuery(this)
                                        .children(0)
                                        .attr('src')
                                        .indexOf('thumbnails/') != -1) {
                                        jQuery(this)
                                            .remove()
                                    }
                                }
                    ...
                    $element.data('contentbuilder')
                        .settings.onRender();
                    if (bDrop) $element.data('contentbuilder')
                        .settings.onDrop(event, ui)
                }
            });
            ...
            if (this.settings.axis != '') {
                jQuery(cb_list)
                    .sortable('option', 'axis', this.settings.axis)
            }
            ...
            $element.droppable({
                drop: function(event, ui) {
                    if (jQuery(ui.draggable)
                        .data('snip')) {
                        var snip = jQuery(ui.draggable)
                            .data('snip');
                        var snipHtml = jQuery('#snip' + snip)
                            .text();
                        jQuery(ui.draggable)
                            .data('snip', null);
            ...
            jQuery(document)
                .bind('mousedown', function(event) {
                    ...
                    if (jQuery(event.target)
                        ...
                        jQuery(".ui-draggable")
                            .removeClass('ui-dragbox-outlined');
                        jQuery(event.target)
                            .parents(".ui-draggable")
                            .addClass('ui-dragbox-outlined');
                        if (is_firefox) jQuery(event.target)
                            .parents(".ui-draggable")
                            .addClass('firefox');
                        jQuery('.row-tool')
                            .stop(true, true)
                        ...
                        if (jQuery(event.target)
                            .parents(".ui-draggable")
                            .find("[data-html-edit='off']")
                            .length > 0 || !$element.data('contentbuilder')
                            .settings.sourceEditor) {
                            jQuery(event.target)
                                .parents(".ui-draggable")
                                .find('.row-tool .row-html')
                                .css({
                                    display: 'none'
                                })
                        }
                    ...
                    if (jQuery(event.target)
                        .parent()
                        .attr('id') == 'rte-toolbar' || jQuery(event.target)
                        .parent()
                        .parent()
                        .attr('id') == 'rte-toolbar') {
                        return
                    ...
                    if (jQuery(event.target)
                        .is('[contenteditable]') || jQuery(event.target)
                        .css('position') == 'absolute' || jQuery(event.target)
                        .css('position') == 'fixed') {
                        return
                    }
                    jQuery(event.target)
                        ...
                        .each(function(e) {
                            if (jQuery(this)
                                .is('[contenteditable]') || jQuery(this)
                                .css('position') == 'absolute' || jQuery(this)
                                .css('position') == 'fixed') {
                                return
                            }
                        });
        ...
        this.html = function() {
            ...
            var html = jQuery('#temp-contentbuilder')
                .html()
                .trim();
        ...
        this.applyBehavior = function() {
            ...
            $element.find("[data-mode='code']")
                .each(function() {
                    jQuery(this)
                        .html(decodeURIComponent(jQuery(this)
                            .attr("data-html")))
                });
            var selectable = this.settings.selectable;
            ...
            $element.find(".embed-responsive")
                .each(function() {
                    ...
                    if (jQuery(this)
                        ...
                        .length == 0) {
                        jQuery(this)
                            .append('<div class="ovl" style="position:absolute;background:#fff;opacity:0.2;cursor:pointer;top:0;left:0px;width:100%;height:100%;z-index:-1"></div>')
                    }
                });
            $element.find(".embed-responsive")
                .hover(function() {
            ...
            $element.find(selectable)
                .focus(function() {
                    var zoom = $element.data('contentbuilder')
                        .settings.zoom;
                    var selectable = $element.data('contentbuilder')
                        .settings.selectable;
                    var is_firefox = navigator.userAgent.toLowerCase()
                        .indexOf('firefox') > -1;
                    jQuery(".ui-draggable")
            ...
            $element.children("div")
                ...
                .click(function() {
                    ...
                    jQuery('#temp-contentbuilder')
                        .find('[contenteditable]')
                        .removeAttr('contenteditable');
                    jQuery('#temp-contentbuilder *[class=""]')
                        .removeAttr('class');
                    jQuery('#temp-contentbuilder *[style=""]')
                        .removeAttr('style');
                    jQuery('#temp-contentbuilder .ovl')
                        .remove();
                    jQuery('#temp-contentbuilder .row-tool')
                        .remove();
                    var html = jQuery('#temp-contentbuilder')
                        .html()
                        .trim();
            ...
            $element.children("div")
                ...
                .click(function() {
                    ...
                    if ($activeRow.data('mode') == 'code') {
                        jQuery('#txtHtml')
                            .val(decodeURIComponent($activeRow.attr('data-html')))
                    } else {
                        jQuery('#temp-contentbuilder')
                            .html($activeRow.html());
                        jQuery('#temp-contentbuilder')
                    ...
                    jQuery('#btnHtmlOk')
                        .bind('click', function(e) {
                            if ($activeRow.data('mode') == 'code') {
                                $activeRow.attr('data-html', encodeURIComponent(jQuery('#txtHtml')
                                    .val()));
                                $activeRow.html('')
                            } else {
                                $activeRow.html(jQuery('#txtHtml')
                                    .val())
                            }
                            jQuery('#md-html')
                                .data('simplemodal')
        ...
        this.destroy = function() {
            ...
            var sHTML = $element.data('contentbuilder')
                .html();
            $element.html(sHTML);
    ...
    jQuery.fn.contentbuilder = function(options) {
        return this.each(function() {
            if (undefined == jQuery(this)
                .data('contentbuilder')) {
                var plugin = new jQuery.contentbuilder(this, options);
                jQuery(this)
                    .data('contentbuilder', plugin)
            }
        })
    }
})(jQuery);
...
(function(jQuery) {
    ...
    jQuery.contenteditor = function(element, options) {
        ...
        this.init = function() {
            ...
            jQuery(document)
                .on("paste", '#' + $element.attr('id'), function(e) {
        ...
        this.render = function() {
            ...
            var editable = $element.data('contenteditor')
                .settings.editable;
            if (editable == '') {
                ...
                $element.bind('mousedown', function(e) {
                    ...
                    if ($element.data('contenteditor')
                        ...
                        jQuery(this)
                            .css('outline', 'rgba(0, 0, 0, 0.43) dashed 1px')
                    }
                })
            } else {
                $element.find(editable)
                    .each(function() {
                        if (jQuery(this)
                            .parents("[data-mode='code']")
                            .length > 0) return;
                        var editMode = $element.data('contenteditor')
                            .settings.editMode;
            ...
            if (editMode == 'default') {
                ...
                $element.find("h1,h2,h3,h4,h5,h6,p")
                    .each(function() {
                        jQuery(this)
                            .parent()
                            .attr('contenteditable', true)
                ...
                $element.find("p")
                    .bind('keydown', function(e) {
                        if (e.keyCode == 13 && $element.find("li")
                            .length == 0) {
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="removeElement"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="removeElement"]')
                .click(function(e) {
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="color"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="color"]')
                .click(function(e) {
                    ...
                    jQuery('.md-pick')
                        .click(function() {
                            ...
                            var selColMode = jQuery('#selColorApplyTo')
                                .val();
                            if (jQuery.trim(text) != '' && jQuery(curr)
                                .text() != text) {
                                if (selColMode == 1) {
                                    document.execCommand("ForeColor", false, jQuery(this)
                                        .css("background-color"))
                                }
                                if (selColMode == 2) {
                                    document.execCommand("BackColor", false, jQuery(this)
                                        .css("background-color"))
                                }
                                        ...
                                        .each(function() {
                                            if (jQuery(this)
                                                ...
                                                if (jQuery(this)
                                                    ...
                                                    .find('span:first')
                                                    .text()) {
                                                    var innerspanstyle = jQuery(this)
                                                        .find('span:first')
                                                        .attr('style');
                                                    jQuery(this)
                                                        .html(jQuery(this)
                                                            .find('span:first')
                                                            .html());
                                                    var newstyle = jQuery(this)
                                                        .attr('style') + ';' + innerspanstyle;
                                                    jQuery(this)
                                                        .attr('style', newstyle)
                                                }
                                            }
                                ...
                                if (selColMode == 2) {
                                    if (jQuery(curr)
                                        .html()) {
                                        jQuery(curr)
                                            .css('background-color', jQuery(this)
                                                .css("background-color"))
                                    } else {
                                        jQuery(curr)
                                            .parent()
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="fontsize"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="fontsize"]')
                .click(function(e) {
                    var savedSel = saveSelection();
                    ...
                    jQuery('#md-fontsize')
                        ...
                        .show();
                    e.preventDefault();
                    if (jQuery('#ifrFontSize')
                        .attr('src')
                        .indexOf('fontsize.html') == -1) {
                        jQuery('#ifrFontSize')
                            .attr('src', sScriptPath + 'fontsize.html')
                    }
                    var text = getSelected();
                    jQuery('.md-pickfontsize')
                        .unbind('click');
                    jQuery('.md-pickfontsize')
                        .click(function() {
                            restoreSelection(savedSel);
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="formatPara"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="formatPara"]')
                .click(function(e) {
                    var savedSel = saveSelection();
                    ...
                    jQuery('#md-headings')
                        ...
                        .show();
                    e.preventDefault();
                    if (jQuery('#ifrHeadings')
                        .attr('src')
                        .indexOf('headings.html') == -1) {
                        jQuery('#ifrHeadings')
                            .attr('src', sScriptPath + 'headings.html')
                    }
                    jQuery('.md-pickheading')
                        .unbind('click');
                    jQuery('.md-pickheading')
                        .click(function() {
                            restoreSelection(savedSel);
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="removeFormat"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="removeFormat"]')
                .click(function(e) {
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="unlink"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="unlink"]')
                .click(function(e) {
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="font"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="font"]')
                .click(function(e) {
                    var savedSel = saveSelection();
                    ...
                    if (jQuery('#ifrFonts')
                        .attr('src')
                        .indexOf('fonts.html') == -1) {
                        jQuery('#ifrFonts')
                            .attr('src', sScriptPath + 'fonts.html')
                    }
                    jQuery('.md-pickfontfamily')
                        .unbind('click');
                    jQuery('.md-pickfontfamily')
                        .click(function() {
                            restoreSelection(savedSel);
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="align"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="align"]')
                .click(function(e) {
                    var savedSel = saveSelection();
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="list"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="list"]')
                .click(function(e) {
                    var savedSel = saveSelection();
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="createLink"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="createLink"]')
                .click(function(e) {
                    var html = "";
                    ...
                    if (el.nodeName.toLowerCase() == 'a') {
                        ...
                        $activeLink = jQuery("a[href='http://dummy']")
                            .first();
                        $activeLink.attr('href', 'http://')
                    }
                    jQuery('#md-createlink')
                        .css('max-width', '800px');
                    jQuery('#md-createlink')
                        .simplemodal({
                            onCancel: function() {
                    ...
                    jQuery('#btnLinkOk')
                        .bind('click', function(e) {
                            $activeLink.attr('href', jQuery('#txtLink')
                                .val());
                            if (jQuery('#txtLink')
                                .val() == 'http://' || jQuery('#txtLink')
                                .val() == '') {
                                $activeLink.replaceWith($activeLink.html())
                            }
                            $activeLink.html(jQuery('#txtLinkText')
                                .val());
                            if (jQuery('#chkNewWindow')
                                .is(":checked")) {
            ...
            $element.find(".embed-responsive")
                .hover(function(e) {
                    ...
                    if (browserok) {
                        ...
                        if (is_ie) {
                            var space = $element.getPos()
                                .top;
                            var adjy_val = (-space / 1.1) * zoom + space / 1.1;
                            var space2 = $element.getPos()
                                .left;
                    ...
                    jQuery("#divFrameLink")
                        .bind('click', function(e) {
                            ...
                            jQuery('#md-createsrc')
                                ...
                                .show();
                            jQuery('#txtSrc')
                                .val($activeFrame.attr('src'));
                            jQuery('#btnSrcOk')
                                .unbind('click');
                            jQuery('#btnSrcOk')
                                .bind('click', function(e) {
                                    var srcUrl = jQuery('#txtSrc')
                                        .val();
            ...
            jQuery("#btnLinkBrowse")
                .unbind('click');
            jQuery("#btnLinkBrowse")
                .bind('click', function(e) {
                    jQuery('#ifrFileBrowse')
                        .attr('src', $element.data('contenteditor')
                            .settings.fileselect);
                    jQuery("#divToolImg")
                        .stop(true, true)
                        .fadeOut(0);
        ...
        this.prepareRteCommand = function(s) {
            jQuery('#rte-toolbar a[data-rte-cmd="' + s + '"]')
                .unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="' + s + '"]')
                .click(function(e) {
                    try {
...
function pasteContent($activeElement) {
    ...
    setTimeout(function() {
        try {
            ...
            if (jQuery('#idContentWord')
                .length == 0) return;
            var sPastedText = '';
            var bRichPaste = false;
            if (jQuery('#idContentWord table')
                .length > 0 || jQuery('#idContentWord img')
                .length > 0 || jQuery('#idContentWord p')
                .length > 0 || jQuery('#idContentWord a')
                .length > 0) {
                bRichPaste = true
            }
            if (bRichPaste) {
                sPastedText = jQuery('#idContentWord')
                    .html();
                sPastedText = cleanHTML(sPastedText);
                jQuery('#idContentWord')
                    .html(sPastedText);
                if (jQuery('#idContentWord')
                    .children('p,h1,h2,h3,h4,h5,h6,ul,li')
                    .length > 1) {
                    jQuery('#idContentWord')
                        .contents()
                        .filter(function() {
                ...
                sPastedText = '<div class="edit">' + jQuery('#idContentWord')
                    .html() + '</div>'
            } else {
                jQuery('#idContentWord')
...
(function(jQuery) {
    ...
    jQuery.imageembed = function(element, options) {
        ...
        this.init = function() {
            ...
            html_hover_icons += '</select>';
            html_hover_icons += '<button class="btn btn-default" id="btnInsertPlh" style="margin-left:12px"> OK </button>';
            html_hover_icons += '</div>' + '</div>' + '<div id="divImgLnk">' + '<div class="md-label">Image URL:</div>' + (bUseCustomImageSelect ? '<input type="text" id="txtImgUrl" class="inptxt" style="float:left;width:50%"></input><i class="cb-icon-link md-btnbrowse" id="btnImageBrowse" style="width:10%;"></i>' : '<input type="text" id="txtImgUrl" class="inptxt" style="float:left;width:60%"></input>') + '<br style="clear:both">' + '<div class="md-label">Alternate Text:</div>' + '<input type="text" id="txtAltText" class="inptxt" style="float:right;width:60%"></input>' + '<br style="clear:both">' + '<div class="md-label">Navigate URL:</div>' + (bUseCustomFileSelect ? '<input type="text" id="txtLinkUrl" class="inptxt" style="float:left;width:50%"></input><i class="cb-icon-link md-btnbrowse" id="btnFileBrowse" style="width:10%;"></i>' : '<input type="text" id="txtLinkUrl" class="inptxt" style="float:left;width:60%"></input>') + '</div>' + '</div>' + '<div id="divImgLnkOk" class="md-footer">' + '<button id="btnImgOk"> Ok </button>' + '</div>' + '</div>' + '</div>' + '' + '<div class="md-modal" id="md-imageselect">' + '<div class="md-content">' + '<div class="md-body">' + (bUseCustomImageSelect ? '<iframe id="ifrImageBrowse" style="width:100%;height:400px;border: none;display: block;" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAJCAYAAADgkQYQAAAAFElEQVQYV2P8DwQMBADjqCKiggAAmZsj5vuXmnUAAAAASUVORK5CYII="></iframe>' : '') + '</div>' + '</div>' + '</div>' + '';
            if (jQuery('#md-fileselect')
                .length == 0) {
            ...
            if (jQuery('#active-input')
                .length == 0) {
                html_hover_icons += '<input type="hidden" id="active-input" />'
            }
            if (jQuery('#divToolImg')
                .length == 0) {
                if (this.settings.imageEmbed) {
                    jQuery('#divCb')
                        .append(html_photo_tool)
                }
                jQuery('#divCb')
                    .append(html_hover_icons)
            }
            ...
            $element.hover(function(e) {
                ...
                if (localStorage.getItem("zoom") != null) {
                    ...
                    zoom = $element.parents('[style*="zoom"]')
                        .css('zoom');
                    if (zoom == 'normal') zoom = 1;
                    if (zoom == undefined) zoom = 1
                }
                ...
                var browserok = true;
                if (is_firefox || is_ie) browserok = false;
                var _top_adj = !jQuery(this)
                    .data("imageembed")
                    .settings.imageEmbed ? 9 : -35;
                if (browserok) {
                    _top = ((offsettop + parseInt(jQuery(this)
                        .css('height')) / 2) - 15) * zoom + (scrolltop - scrolltop * zoom);
                    _left = ((offsetleft + parseInt(jQuery(this)
                        .css('width')) / 2) - 15) * zoom;
                    _top2 = _top + _top_adj
                } else {
                    if (is_ie) {
                        ...
                        var p = jQuery(this)
                            .getPos();
                        _top = ((p.top - 15 + parseInt(jQuery(this)
                            .css('height')) / 2)) * zoom + adjy_val;
                        _left = ((p.left - 15 + parseInt(jQuery(this)
                            .css('width')) / 2)) * zoom + adjx_val;
                        _top2 = _top + _top_adj
                    }
                    if (is_firefox) {
                        var imgwidth = parseInt(jQuery(this)
                            .css('width'));
                        var imgheight = parseInt(jQuery(this)
                            .css('height'));
                ...
                jQuery("#divToolImg")
                    .bind('click', function(e) {
                        jQuery(this)
                            .data('image', $imgActive);
                        jQuery('input.my-file[type=file]')
                            .click();
                        e.preventDefault();
                        e.stopImmediatePropagation()
                    });
                    ...
                    .bind('click', function(e) {
                        ...
                        jQuery('#btnImgOk')
                            .bind('click', function(e) {
                                ...
                                $img.attr('src', jQuery('#txtImgUrl')
                                    .val());
                                $img.attr('alt', jQuery('#txtAltText')
                                    .val());
                                $img.css('width', '');
                                $img.css('height', '');
                                if (jQuery('#txtLinkUrl')
                                    .val() == 'http://' || jQuery('#txtLinkUrl')
                                    .val() == '') {
                                    $img.parents('a:first')
                                        .replaceWith($img.parents('a:first')
                                            .html())
                                } else {
                                    if ($img.parents('a:first')
                                        .length == 0) {
                                        $img.wrap('<a href="' + jQuery('#txtLinkUrl')
                                            .val() + '"></a>')
                                    } else {
                                        $img.parents('a:first')
                                            .attr('href', jQuery('#txtLinkUrl')
                                                .val())
                                    }
                                }
                        ...
                        jQuery('#btnInsertPlh')
                            .bind('click', function(e) {
                                ...
                                $img.attr('alt', jQuery('#txtAltText')
                                    .val());
                                $img.css('width', jQuery('#selImgW')
                                    .val() + 'px');
                                $img.css('height', jQuery('#selImgH')
                                    .val() + 'px');
                                if (jQuery('#selImgStyle')
                                    .val() == 'circle') {
                ...
                jQuery("#btnImageBrowse")
                    .unbind('click');
                jQuery("#btnImageBrowse")
                    .bind('click', function(e) {
                        jQuery('#ifrImageBrowse')
                            .attr('src', $element.data('imageembed')
                                .settings.imageselect);
                        jQuery("#divToolImg")
                            .stop(true, true)
                            .fadeOut(0);
                        jQuery("#divToolImgSettings")
        ...
        var changeImage = function(e) {
            ...
            var hiquality = false;
            try {
                hiquality = $element.data('imageembed')
                    .settings.hiquality
            } catch (e) {};
            for (var i = 0, file; file = files[i]; i++) {
                ...
                if (file.type.match('image.*')) {
                    ...
                    jQuery('body')
                        .css('overflow', 'hidden');
                    jQuery("#divToolImgLoader")
                        .css('top', jQuery('#divToolImg')
                            .css('top'));
                    jQuery("#divToolImgLoader")
                        .css('left', jQuery('#divToolImg')
                            .css('left'));
                    jQuery("#divToolImgLoader")
                        .css('display', 'block');
                    ...
                    reader.onload = (function(theFile) {
                        return function(e) {
                            ...
                            if ($imgActive.prop("tagName")
                                .toLowerCase() == 'img') {
                                jQuery("#my-mask")
                                    .css('width', $imgActive.width() + 'px');
                                jQuery("#my-mask")
                                    .css('height', $imgActive.height() + 'px')
                            } else {
                                jQuery("#my-mask")
                                    .css('width', $imgActive.innerWidth() + 'px');
                                jQuery("#my-mask")
                                    .css('height', $imgActive.innerHeight() + 'px')
                            }
                            jQuery("#my-mask")
                                .css('zoom', zoom);
                            jQuery("#my-mask")
                            ...
                            oimg.onload = function(evt) {
                                ...
                                jQuery('#my-image')
                                    .on('load', function() {
                                        ...
                                        var scrolltop = jQuery(window)
                                            .scrollTop();
                                        var offsettop = $imgActive.offset()
                                            .top;
                                        var offsetleft = $imgActive.offset()
                                            .left;
                                        var is_firefox = navigator.userAgent.toLowerCase()
                                            .indexOf('firefox') > -1;
                                        var is_ie = detectIE();
                                        ...
                                        if (browserok) {
                                            ...
                                            if (is_firefox) {
                                                ...
                                                jQuery('#img-control')
                                                    .css('top', 5 + adjy_val + 'px');
                                                jQuery('#img-control')
                                                    .css('left', 7 + adjx_val + 'px');
                                        ...
                                        if ($imgActive.attr('class') == 'img-polaroid') {
                                            jQuery("#divImageEdit")
                                                .css("top", _top_polaroid + "px");
                                            jQuery("#divImageEdit")
                                                .css("left", _left_polaroid + "px")
                                        } else {
                                            jQuery("#divImageEdit")
                                                .css("top", _top + "px");
                                            jQuery("#divImageEdit")
                                        ...
                                        if ($imgActive.attr('class') == 'img-circle') {
                                            jQuery('#my-mask')
                                                .css('-webkit-border-radius', '500px');
                                            jQuery('#my-mask')
                                                .css('-moz-border-radius', '500px');
                                            jQuery('#my-mask')
                                ...
                                jQuery('#btnChangeImage')
                                    .bind('click', function() {
                                        ...
                                        } else if ($imgActive.prop("tagName")
                                            .toLowerCase() == 'figure') {
                                            $imgActive.find('img')
                                                .attr('src', image);
                                            $imgActive.find('img')
                                        ...
                                        $element.data('imageembed')
                                            .settings.onChanged()
                                    });
                                jQuery('#btnImageCancel')
                                    .unbind('click');
                                jQuery('#btnImageCancel')
                                    .bind('click', function() {
                                        var canvas = document.getElementById('myCanvas');
                                ...
                                jQuery('#btnZoomIn')
                                    .bind('click', function() {
                                        var nCurrentWidth = parseInt(jQuery("#my-image")
                                            .css('width'));
                                        var nCurrentHeight = parseInt(jQuery("#my-image")
                                            .css('height'));
                                        jQuery("#my-image")
                                            .css('width', (nCurrentWidth / 0.9) + 'px');
                                        jQuery("#my-image")
                                            .css('height', (nCurrentHeight / 0.9) + 'px');
                                        panSetup();
                                ...
                                jQuery('#btnZoomOut')
                                    .bind('click', function() {
                                        ...
                                        var nCurrentHeight = parseInt(jQuery("#my-image")
                                            .css('height'));
                                        if ((nCurrentWidth / 1.1) < jQuery("#my-mask")
                                            .width()) return;
                                        if ((nCurrentHeight / 1.1) < jQuery("#my-mask")
                                            .height()) return;
                                        jQuery("#my-image")
                                            .css('width', (nCurrentWidth / 1.1) + 'px');
                                        jQuery("#my-image")
                                            .css('height', (nCurrentHeight / 1.1) + 'px');
                                        panSetup();
        ...
        var crop = function() {
            var x = parseInt(jQuery("#my-image")
                .css('left'));
            var y = parseInt(jQuery("#my-image")
                .css('top'));
            var dw = parseInt(jQuery("#my-mask")
                .css('width'));
            var dh = parseInt(jQuery("#my-mask")
                .css('height'));
            var canvas = document.getElementById('myCanvas');
        ...
        var panSetup = function() {
            ...
            var maskWidth = jQuery("#my-mask")
                .width();
            var maskHeight = jQuery("#my-mask")
                .height();
            var imgPos = jQuery("#my-image")
                .offset();
            var imgWidth = jQuery("#my-image")
                .width();
            var imgHeight = jQuery("#my-image")
                .height();
...
jQuery.fn.clearFields = jQuery.fn.clearInputs = function(includeHidden) {
    ...
    return this.each(function() {
        ...
        if (re.test(t) || tag == 'textarea') {
            ...
            if ((includeHidden === true && /hidden/.test(t)) || (typeof includeHidden == 'string' && jQuery(this)
                    .is(includeHidden))) this.value = ''
        }
    })
};
(function(jQuery) {
